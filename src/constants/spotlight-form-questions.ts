...
const featureOptions = [
  { label: "Option 1: Email Marketing", value: "email_marketing" },
  { label: "Option 2: 2-Way SMS / Call Marketing", value: "two_way_sms_call_marketing" },
  { label: "Option 3: Booking & Appointment", value: "booking_appointment" },
  { label: "Option 4: Call Tracking", value: "call_tracking" },
  { label: "Option 5: Surveys & Forms", value: "surveys_forms" },
  { label: "Option 6: Tracking & Analytics", value: "tracking_analytics" },
  { label: "Option 7: Communities", value: "communities" },
  { label: "Option 8: Chatbot", value: "chatbot" },
];

export const spotlightFormSteps: StepDef[] = [
  {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Do you want animations on scroll?",
        type: "radio",
        options: [
          { label: "Yes", value: "yes" },
          { label: "No", value: "no" },
      ...
      },
      {
        ...
        label: "Do you want a video background in the hero section?",
        type: "radio",
        options: [
          { label: "Yes", value: "yes" },
          { label: "No", value: "no" },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "needSubscriptionSetup",
        label: "Do you need subscription setup?",
        type: "radio",
        options: [
          { label: "Yes", value: "yes" },
          { label: "No", value: "no" },
      ...
      {
        name: "needMembershipArea",
        label: "Do you need a membership area?",
        type: "radio",
        options: [
          { label: "Yes", value: "yes" },
          { label: "No", value: "no" },
      ...
      {
        name: "needCourseHosting",
        label: "Do you need course hosting?",
        type: "radio",
        options: [
          { label: "Yes", value: "yes" },
          { label: "No", value: "no" },
  ...
  {
    title: "Select 2 Features To Be Added In Your Plan",
    fields: [
      {
        name: "selectedFeatureOne",
